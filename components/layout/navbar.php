            ...
            <div id="navMenu" class="navbar-menu">
                ...
                <div class="navbar-end">
                    <div class="navbar-item">
                        <div class="buttons">
                            <button class="button is-ghost"> <a href="https://discord.gg/QJauGpg7zg">Discord</a> </button>
                            <button class="button is-ghost"> <a href="https://discord.gg/QJauGpg7zg">Twitter</a> </button>
                            <?php if (!isset($_SESSION["user_id"])) : ?>
